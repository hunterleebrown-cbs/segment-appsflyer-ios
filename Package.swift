...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "AppsFlyerLib-Dynamic" , url: "https://github.com/AppsFlyerSDK/AppsFlyerFramework-Dynamic", .branch("main")),
    ],
    targets: [
        ...
        .target(
            ...
            dependencies: [
                "Segment",
                .product(name: "AppsFlyerLib", package: "AppsFlyerLib-Dynamic"),
                ],
